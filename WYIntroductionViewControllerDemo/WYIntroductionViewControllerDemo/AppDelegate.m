...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (version == nil || ![version isEqualToString:currentAppVersion]) {
        ...
        WYIntroductionViewController *vc = [[WYIntroductionViewController alloc] init];
        vc.images = @[@"IMG_0.jpg",@"IMG_1.jpg",@"IMG_2.jpg"];
        vc.currentColor = [UIColor redColor];
        vc.enterType_Btn = YES;
